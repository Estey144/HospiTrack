...
const Signup = () => {
  ...
  return (
    <div className="patient-signup-page">
      {/* Background floating shapes matching login page */}
      <div className="patient-signup-background">
        <div className="patient-signup-floating-shapes">
          <div className="patient-signup-shape patient-signup-shape-1"></div>
          <div className="patient-signup-shape patient-signup-shape-2"></div>
          <div className="patient-signup-shape patient-signup-shape-3"></div>
          <div className="patient-signup-shape patient-signup-shape-4"></div>
        </div>
      </div>
